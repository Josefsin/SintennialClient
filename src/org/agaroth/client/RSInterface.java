...
public class RSInterface {
	...
	protected static TextDrawingArea[] fonts;
			...
			if (rsInterface.type == 2) {
				...
				for (int l3 = 0; l3 < 5; l3++) {
					...
					if (rsInterface.parentID == 5292)
						rsInterface.actions[4] = "Withdraw-X";
				}
			}
	...
	public static void addPouch(int ID, int r1[], int ra1, int r2, int lvl,
		...
		rsInterface.tooltip = (new StringBuilder()).append("Make scroll @or1@").append(name).toString();
		rsInterface.spellName = name;
