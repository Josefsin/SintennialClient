...
public final class ObjectDefinition {
    ...
    public static ObjectDefinition forID(int id) {
        ...
        if(definition.type == 24452) {
        	definition.name = "Drop Table";
        	definition.hasActions = true;
        	definition.actions = new String[] {"View", null, null, null, null};
        }
        if(definition.type == 2465) {
        	definition.name = "FFA Portal";
        	definition.hasActions = true;
        	definition.actions = new String[5];
        ...
        if(definition.name != null && definition.type != 591) {
            ...
            if(s.contains("bank") && !s.contains("closed")) {
                definition.actions = new String[5];
                definition.actions[0] = "Use";
              //  definition.actions[1] = "Grand Exchange";
            }
        }
        ...
        if(definition.type == 884 || definition.type == 26945) {
        ...
        {
            definition.name = "Extreme Zone Portal";
        }
        ...
        if(definition.type == 2403) {
        	definition.name = "Death's Chest";
        }
        ...
        case 2152:
            ...
            definition.actions[1] = "Infuse Scrolls";
            definition.actions[2] = "Renew Points";
