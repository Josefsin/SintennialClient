...
public class CustomInterfaces extends RSInterface {
	...
	public static void rcInterface(TextDrawingArea[] tda) {
		RSInterface RSInterface = addInterface(26100);
		addSprite(26101, 1205, 1205, -1, -1);
		addButton(26102, 1190, "Craft", 32, 32);
		addButton(26103, 1191, "Craft", 32, 32);
		addButton(26104, 1192, "Craft", 32, 32);
		addButton(26105, 1193, "Craft", 32, 32);
		addButton(26106, 1194, "Craft", 32, 32);
		addButton(26107, 1195, "Craft", 32, 32);
		addButton(26108, 1196, "Craft", 32, 32);
		addButton(26109, 1197, "Craft", 32, 32);
		addButton(26110, 1198, "Craft", 32, 32);
		addButton(26111, 1199, "Craft", 32, 32);
		addButton(26112, 1200, "Craft", 32, 32);
		addButton(26113, 1201, "Craft", 32, 32);
		addButton(26114, 1202, "Craft", 32, 32);
		addButton(26115, 1203, "Craft", 32, 32);
		addButton(26116, 1204, "Craft", 32, 32);
		addText(26117, "What rune would you like to craft?", 0xFF981F, false, true, 52, tda, 1);
		setChildren(17, RSInterface);
		setBounds(26101, 60, 35, 0, RSInterface);
		setBounds(26102, 104, 89, 1, RSInterface); // Air Rune
		setBounds(26103, 174, 89, 2, RSInterface); // Mind Rune
		setBounds(26104, 243, 89, 3, RSInterface); // Water Rune
		setBounds(26105, 311, 89, 4, RSInterface); // Earth Rune
		setBounds(26106, 382, 89, 5, RSInterface); // Fire Rune
		setBounds(26107, 104, 152, 6, RSInterface); // Body Rune
		setBounds(26108, 174, 152, 7, RSInterface); // Cosmic Rune
		setBounds(26109, 243, 152, 8, RSInterface); // Chaos Rune
		setBounds(26110, 311, 152, 9, RSInterface); // Astral Rune
		setBounds(26111, 382, 152, 10, RSInterface); // Nature Rune
		setBounds(26112, 104, 214, 11, RSInterface); // Law Rune
		setBounds(26113, 174, 214, 12, RSInterface); // Death Rune
		setBounds(26114, 243, 214, 13, RSInterface); // Blood Rune
		setBounds(26115, 311, 214, 14, RSInterface); // Soul Rune
		setBounds(26116, 383, 214, 15, RSInterface); // Armadyl Rune
		setBounds(26117, 190, 44, 16, RSInterface); // Runecrafting Options Text
	...
	private void playerPanel() {
		...
		addText(39155, "Player Panel", tda, 2, 16750623, false, true);
		...
		for(int i = 39159; i < 39214; i++) {
			...
			k++;
			if(i == 39164) {
				addClickableText(i, "", "DD", tda, 1, 0xff0000, 167, 13);
			} else if(i == 39165) {
				addClickableText(i, "", "AI", tda, 1, 0xff0000, 167, 13);
			} else if(i == 39166 || i == 39174) {
				addClickableText(i, "", "PS", tda, 1, 0xff0000, 167, 13);
			} else if(i == 39167 || i == 39202) {
				addClickableText(i, "", "SI", tda, 1, 0xff0000, 167, 13);
			} else if(i == 39168 || i ==39193 || i >= 39205 && i <= 39210) {
				addClickableText(i, "", "PM", tda, 1, 0xff0000, 167, 13);
			} else if(i == 39170 || i ==39193 || i >= 39205 && i <= 39210) {
				addClickableText(i, "", "IL", tda, 1, 0xff0000, 167, 13);
			} else if(i == 39171 || i ==39193 || i >= 39205 && i <= 39210) {
				addClickableText(i, "", "C", tda, 1, 0xff0000, 167, 13);
			}
			else {
	...
	private void playersOnline() {
		...
		addText(57007, "sintennialps.freeforums.net", 0xff9933, true, true, -1, tda, 0);
...
/*	private void commandsInterface() {
		RSInterface tab2 = addInterface(57000);
		addSpriteLoader(57001, 655);
		addText(57002, "::commands works!", 0xff9933, true, true, -1, tda, 2);
		addButton(26003, 4, -1, 427, 427, 15, 15, "Close", 427, 1);
		setBounds(15001, 8, 205, 0, tab2);
		setBounds(15002, 53, 205, 1, tab2);
		setBounds(15003, 98, 205, 2, tab2);
		setBounds(15004, 143, 205, 3, tab2);
		setBounds(1644, 0, 0, 4, tab2);
	} */
}
