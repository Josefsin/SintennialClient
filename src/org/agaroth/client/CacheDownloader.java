...
public class CacheDownloader {
	...
	private static final String CACHE_FILE_NAME = "SintennialCacheV2.zip"; //The name of the actual .zip file
	private static final String CACHE_URL = "https://dl.dropboxusercontent.com/s/o8ey3wav8jvlhie/SintennialCacheV2.zip"; //The url to the .zip file
	private static final String NEWEST_VERSION_FILE_URL = "https://dl.dropboxusercontent.com/s/o8ey3wav8jvlhie/SintennialCacheV2.zip"; //The url to the current cache_versiont txt file
	private static final String CURRENT_VERSION_FILE = "https://dl.dropboxusercontent.com/s/o8ey3wav8jvlhie/SintennialCacheV2.zip"; //The location of the local cache_version txt file
	
	public static final String URL_TO_LOADING_IMAGES = "https://dl.dropboxusercontent.com/s/o8ey3wav8jvlhie/SintennialCacheV2.zip";
	public static final String MIRROR_URL_TO_LOADING_IMAGES = "https://dl.dropboxusercontent.com/s/o8ey3wav8jvlhie/SintennialCacheV2.zip"; //If first link is broken, it will attempt to download from here
