...
public class AccountManager {
	...
	private void load() {
		try {
			FileInputStream fin = new FileInputStream(Signlink.getCacheDirectory() + "/" + FILE_NAME);
	...
	public void save() {
		try {
			FileOutputStream fout = new FileOutputStream(Signlink.getCacheDirectory() + "/" + FILE_NAME);
