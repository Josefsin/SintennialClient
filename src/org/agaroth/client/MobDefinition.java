...
public final class MobDefinition {
	...
	public static MobDefinition get(int id) {
		...
		switch (id) {
		case 501:
			definition.name = "Draynor Spirit";
		...
		case 6537:
			...
			definition.actions[2] = "Teleport Revenants";
			definition.actions[4] = "Teleport FFA Arena";
		...
		case 519:
			...
			break;
		case 462:
			definition.name = "Runecrafter wizard";
			definition.actions = new String[] {"Talk-to", null, "Essence mine", "Bank", "Restore run", null ,null};
			break;
		case 3777:
			definition.name = "Member Wizard";
			definition.actions = new String[] {"Talk-to", null, "View Shop", null, "Member Zone", null, null};
			break;
		case 3580:
			definition.combatLevel = 80;
			break;
		case 4476:
			definition.actions = new String[] {"Talk-to", null, "Enter pyramid", "Skip floors", null};
			break;
		case 2891:
		...
		case 1999:
			...
			definition.npcModels[1] = 29270;
			definition.combatLevel = 318;
			definition.standAnimation = 4484;
			definition.walkAnimation = 4488;
			definition.actions = new String[5];
			definition.originalModelColours = new int[] {29270};
			definition.actions = new String[] {null, "Attack", null, null, null};
			definition.adjustVertextPointZ = 100;
			definition.adjustVertextPointsXOrY = 100;
		 break;
		case 6766:
			definition.name = "Lizardman shaman";
			definition.description = "It's a lizardman.".getBytes();
			definition.combatLevel = 150;
			definition.walkAnimation = 7195;
			definition.standAnimation = 7191;
			definition.actions = new String[5];
			definition.actions[1] = "Attack";
			definition.npcModels = new int[1];
			definition.npcModels[0] = 4039;
		...
		case 5886:
			...
			break;
		case 499:
			definition.name = "Thermonuclear smoke devil";
			definition.description = "It looks like its glowing".getBytes();
			definition.combatLevel = 301;
			definition.walkAnimation = 1828;
			definition.standAnimation = 1829;
			definition.actions = new String[5];
			definition.actions[1] = "Attack";
			definition.npcModels = new int[1];
			definition.npcModels[0] = 28442;
			definition.adjustVertextPointZ = 240;
			definition.adjustVertextPointsXOrY = 240;
			definition.npcSizeInSquares = 4;
			break;
		case 7286:
			definition.name = "Skotizo";
			definition.description = "Badass from the depths of hell".getBytes();
			definition.combatLevel = 321;
			MobDefinition skotizo = get(4698);
			definition.standAnimation = skotizo.standAnimation;
			definition.walkAnimation = skotizo.walkAnimation;
			definition.actions = new String[5];
			definition.actions[1] = "Attack";
			definition.npcModels = new int[1];
			definition.npcModels[0] = 31653;
			definition.adjustVertextPointZ = 80;
			definition.adjustVertextPointsXOrY = 80;
			definition.npcSizeInSquares = 3;
			break;
		case 2902:
			definition.name = "Whirpool";
		...
		case 10216:
			...
			break;
		case 7969:
			definition.actions = new String[]{null, null, "Trade", null, null};
			break;
		case 1382:
		...
		case 6970:
			...
			break;
		case 4657:
			definition.actions = new String[] {"Open stores", null, null, null, "Teleport"};
			break;
		case 605:
		...
		case 8444:
			...
			break;
		case 461:
			definition.name = "RuneSpan wizard";
			definition.actions = new String[5];
		...
		case 2579:
			...
			definition.description = "One of Sintennial's veterans.".getBytes();
