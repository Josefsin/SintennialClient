...
public final class ItemDefinition {
	...
	public static ItemDefinition get(int id) {
		...
		case 2722:
			...
			break;
		case 11797:
			itemDef.name = "Death Key";
			break;
		case 12825:
			itemDef.name = "Steel titan scroll";
			itemDef.actions = new String[] { null, "Special attack", null, null, "Drop" };
			break;
		case 1321:
			itemDef.name = "Bronze scimitar";
			...
			itemDef.maleWearId = 490;
			itemDef.femaleWearId = 490;
			break;
		case 1323:
			itemDef.name = "Iron scimitar";
			itemDef.modelZoom = 1180;
			itemDef.modelRotation1 = 300;
			itemDef.modelRotation2 = 1120;
			itemDef.modelOffset1 = -6;
		...
		case 1329:
			...
			itemDef.originalModelColors = new int[1];
			itemDef.modifiedModelColors[0] = 61;
			itemDef.originalModelColors[0] = -22239;
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wield", null, null, "Drop" };
			itemDef.modelID = 2373;
			itemDef.maleWearId = 490;
	 ...
	 /*   case 12926:
		...
		case 18355:
			...
			break;
		case 19670:
			itemDef.name = "Rigged seeds";
			itemDef.actions = new String[5];
			itemDef.actions[4] = "Drop";
			itemDef.actions[0] = "Spawn";
			break;
		case 10034:
		case 10033:
			itemDef.actions = new String[] { null, null, null, null, "Drop"};
		...
		case 21638:
			...
			itemDef.modifiedModelColors = new int[2];
			itemDef.modifiedModelColors[0] = 933;
			itemDef.originalModelColors[0] = 14878179;
			itemDef.modelID = 2537;
			itemDef.modelZoom = 540;
			itemDef.modelRotation1 = 72;
			itemDef.modelRotation2 = 136;
			...
			itemDef.description = "Pink Santa hat.".getBytes();
			break;
		case 21639:
			itemDef.actions = new String[5];
			itemDef.actions[1] = "Wear";
			...
			itemDef.description = "Lime Santa hat.".getBytes();
			break;
		case 21640:
			itemDef.actions = new String[5];
			itemDef.actions[1] = "Wear";
			...
			itemDef.description = "Aqua Santa hat.".getBytes();
			break;
		case 21641:
			itemDef.actions = new String[5];
			itemDef.actions[1] = "Wear";
			...
			itemDef.description = "White Santa hat.".getBytes();
			break;
		case 21642:
			itemDef.actions = new String[5];
			itemDef.actions[1] = "Wear";
		...
		case 21643:
			...
			itemDef.description = "Lava Santa hat.".getBytes();
			break;
		    case 21644:
			itemDef.actions = new String[5];
			itemDef.actions[1] = "Wear";
			...
			itemDef.description = "Black h'ween Mask.".getBytes();
			break;
		    case 21645:
				itemDef.actions = new String[5];
				itemDef.actions[1] = "Wear";
				...
				itemDef.description = "Pink h'ween Mask.".getBytes();
				break;
		    case 21646:
				itemDef.actions = new String[5];
				itemDef.actions[1] = "Wear";
				...
				itemDef.description = "Lime h'ween Mask.".getBytes();
				break;
		    case 21647:
				itemDef.actions = new String[5];
				itemDef.actions[1] = "Wear";
				...
				itemDef.description = "Aqua h'ween Mask.".getBytes();
				break;
		    case 21648:
				itemDef.actions = new String[5];
				itemDef.actions[1] = "Wear";
				...
				itemDef.description = "White h'ween Mask.".getBytes();
				break;
		    case 21649:
				itemDef.actions = new String[5];
				itemDef.actions[1] = "Wear";
				...
				itemDef.description = "Purple h'ween Mask.".getBytes();
				break;
		    case 21650:
				itemDef.actions = new String[5];
				itemDef.actions[1] = "Wear";
				...
				itemDef.description = "Lava h'ween Mask.".getBytes();
				break;
		    case 21651:
		    	itemDef.actions = new String[5];
		    	itemDef.actions[1] = "Wear";
		    	...
		    	break;
		    case 14050:
		        ItemDefinition clone = ItemDefinition.get(15459);
		        itemDef.modelID = clone.modelID;
		        itemDef.modelZoom = clone.modelZoom;
		        itemDef.modelRotation1 = clone.modelRotation1;
		        itemDef.modelRotation2 = clone.modelRotation2;
		        itemDef.modelOffset1 = clone.modelOffset1;
		        itemDef.modelOffsetY = clone.modelOffsetY;
		        itemDef.maleWearId = clone.maleWearId;
		    	itemDef.femaleWearId = clone.femaleWearId;
		    	itemDef.maleDialogue = clone.maleDialogue;
		    	itemDef.femaleDialogue = clone.femaleDialogue;
		    	itemDef.certID = clone.certID;
		    	itemDef.certTemplateID = clone.certTemplateID;
		    	itemDef.actions = clone.actions;
		    	itemDef.modifiedModelColors = new int[2];
		    	itemDef.originalModelColors = new int[2];
		        itemDef.modifiedModelColors[0] = 22439;
		        itemDef.modifiedModelColors[1] = 43955;
		    	itemDef.originalModelColors[0] = 350;
		    	itemDef.originalModelColors[1] = 350;
		        itemDef.name = "Defender lvl 6";
		        break;
		    case 14052:
		        clone = ItemDefinition.get(15459);
		        itemDef.modelID = clone.modelID;
		        itemDef.modelZoom = clone.modelZoom;
		        itemDef.modelRotation1 = clone.modelRotation1;
		        itemDef.modelRotation2 = clone.modelRotation2;
		    ...
		    case 14054:
		        ...
		        itemDef.modifiedModelColors[0] = 22439;
		        itemDef.modifiedModelColors[1] = 43955;
		    	itemDef.originalModelColors[0] = 49863;
		    	itemDef.originalModelColors[1] = 49863;
		        itemDef.name = "Defender lvl 8";
		        break;
		    case 21652:
		    	itemDef.actions = new String[5];
		    	itemDef.actions[1] = "Wear";
		    	...
		    	itemDef.description = "An Pink Party Hat.".getBytes();
		    	break;
		    case 21653:
		    	itemDef.actions = new String[5];
		    	itemDef.actions[1] = "Wear";
		    	...
		    	itemDef.description = "An Lava Party Hat.".getBytes();
		    	break;
		    case 21654:
		    	itemDef.actions = new String[5];
		    	itemDef.actions[1] = "Wear";
		    	...
		    	itemDef.femaleWearId = 363;
		    	itemDef.stackable = false;
		    	itemDef.name = "Aqua Party Hat";
		    	itemDef.description = "An Aqua Party Hat.".getBytes();
		    	break;
		case 20100:
			...
			break;
		case 20104:
			itemDef.name = "Free to play starter pack";
			itemDef.modelZoom = 1180;
		...
		case 20117:
			...
			itemDef.modelID = 9597;
			itemDef.maleWearId = 8962;
			itemDef.femaleWearId = 8962;
			break;
		case 20115:
			...
			itemDef.originalModelColors = new int[] { 171, 1447, 1455, 1566, 1938, 1690 };
			...
			break;
		case 20116:
			itemDef.name = "Ward upgrade kit";
			itemDef.modelZoom = 1310;
			itemDef.modelRotation1 = 163;
			itemDef.modelRotation2 = 73;
			itemDef.originalModelColors = new int[] { -32339, 31019, 31027, 31139, 31382, 31134 };
			itemDef.modifiedModelColors = new int[] { -32709, 10295, 10304, 10287, 10275, 10283 };
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, null, null, null, "Drop" };
			itemDef.modelID = 4847;
		...
		case 20129:
			...
			itemDef.modelRotation1 = 454;
			itemDef.modelRotation2 = 1283;
			itemDef.modelOffset1 = -4;
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", null, null, "Drop" };
			itemDef.modelID = 28637;
			itemDef.maleWearId = 28485;
			itemDef.femaleWearId = 28485;
			break;
		case 20131:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", null, null, "Drop" };
			itemDef.modelID = 28644;
			itemDef.maleWearId = 28520;
			itemDef.femaleWearId = 28590;
			break;
		case 20139:
		...
		case 20176:
			...
			itemDef.maleWearId = 28512;
			itemDef.femaleWearId = 28581;
			break;
		case 20142:
			...
			itemDef.maleWearId = 28516;
			itemDef.femaleWearId = 28584;
			break;
		case 20271:
			itemDef.name = "Briefcase";
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wield", null, null, "Drop" };
			itemDef.modelID = 28660;
			itemDef.maleWearId = 8954;
			itemDef.femaleWearId = 8954;
			break;
		case 20149:
			...
			itemDef.maleWearId = 28453;
			itemDef.femaleWearId = 28453;
			break;
		case 20150:
			...
			itemDef.originalModelColors = new int[] { -29257, -29137, 10392, -29143, 10392 };
			itemDef.modifiedModelColors = new int[] { -22440, 70, 5037, 5027, 5400 };
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", null, null, "Drop" };
			itemDef.modelID = 28474;
			itemDef.maleWearId = 28457;
			itemDef.femaleWearId = 28461;
			break;
		case 20151:
			...
			itemDef.originalModelColors = new int[] { -29257, -29137, 10392 };
			itemDef.modifiedModelColors = new int[] { -22440, 70, 5037 };
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", null, null, "Drop" };
			itemDef.modelID = 28470;
			itemDef.maleWearId = 28450;
			itemDef.femaleWearId = 28459;
			break;
		case 20274:
			...
			itemDef.originalModelColors = new int[] { 5272, 5157 };
			itemDef.modifiedModelColors = new int[] { 4626, 8101 };
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", null, null, "Drop" };
			itemDef.modelID = 28471;
			itemDef.maleWearId = 28458;
			itemDef.femaleWearId = 28458;
			break;
		case 20153:
			...
			itemDef.maleWearId = 28445;
			itemDef.femaleWearId = 28445;
			break;
		case 20157:
		...
		case 20158:
			...
			itemDef.maleWearId = 8963;
			itemDef.femaleWearId = 8963;
			break;
		case 20159:
			itemDef.name = "Odium ward";
			itemDef.modelZoom = 1474;
			...
			itemDef.maleWearId = 8960;
			itemDef.femaleWearId = 8960;
			break;
		case 21363:
			itemDef.name = "Drygore rapier";
			...
			itemDef.modelID = 62763;
			itemDef.maleWearId = 62856;
			itemDef.femaleWearId = 62856;
		break;
		case 20202:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wield", "Check-charges", null, "Drop" };
			itemDef.modelID = 62966;
			itemDef.maleWearId = 62954;
			itemDef.femaleWearId = 62954;
		break;
		case 20203:
			...
			itemDef.maleWearId = 62860;
			itemDef.femaleWearId = 62860;
		break;
		case 20204:
			...
			itemDef.maleWearId = 63425;
			itemDef.femaleWearId = 63425;
		break;
		case 21347:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Check-charges", null, "Drop" };
			itemDef.modelID = 63372;
			itemDef.maleWearId = 63416;
			itemDef.femaleWearId = 63469;
		break;
		case 21349:
			...
			itemDef.maleWearId = 63368;
			itemDef.femaleWearId = 63428;
		break;
		case 21350:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Check-charges", null, "Drop" };
			itemDef.modelID = 63365;
			itemDef.maleWearId = 63362;
			itemDef.femaleWearId = 63422;
		break;
		case 21351:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Check-charges", null, "Drop" };
			itemDef.modelID = 63361;
			itemDef.maleWearId = 63415;
			itemDef.femaleWearId = 63467;
		break;
		case 21352:
			...
			itemDef.maleWearId = 63167;
			itemDef.femaleWearId = 63426;
		break;
		case 20301:
			...
			itemDef.modelID = 64722;
			itemDef.maleWearId = 64657;
			itemDef.femaleWearId = 64686;
		break;
		case 20302:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Split", null, "Drop" };
			itemDef.modelID = 64723;
			itemDef.maleWearId = 64668;
			itemDef.femaleWearId = 64697;
		break;
		case 20304:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Split", null, "Drop" };
			itemDef.modelID = 64716;
			itemDef.maleWearId = 64664;
			itemDef.femaleWearId = 64693;
		break;
		case 20305:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Split", null, "Drop" };
			itemDef.modelID = 64721;
			itemDef.maleWearId = 64654;
			itemDef.femaleWearId = 64683;
		break;
		case 20306:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Split", null, "Drop" };
			itemDef.modelID = 64719;
			itemDef.maleWearId = 64652;
			itemDef.femaleWearId = 64681;
		break;
		case 20307:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Split", null, "Drop" };
			itemDef.modelID = 64729;
			itemDef.maleWearId = 64662;
			itemDef.femaleWearId = 64691;
		break;
		case 20308:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Split", null, "Drop" };
			itemDef.modelID = 64730;
			itemDef.maleWearId = 64669;
			itemDef.femaleWearId = 64698;
		break;
		case 20310:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Split", null, "Drop" };
			itemDef.modelID = 64725;
			itemDef.maleWearId = 64655;
			itemDef.femaleWearId = 64684;
		break;
		case 20311:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Split", null, "Drop" };
			itemDef.modelID = 64731;
			itemDef.maleWearId = 64653;
			itemDef.femaleWearId = 64682;
		break;
		case 20312:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", "Split", null, "Drop" };
			itemDef.modelID = 64728;
			itemDef.maleWearId = 64665;
			itemDef.femaleWearId = 64695;
		break;
		case 20313: 
			itemDef.name = "ANONYMUS";
			itemDef.modelZoom = 900;
			itemDef.modelRotation1 = 406;
			itemDef.modelRotation2 = 2041;
			itemDef.modelOffset1 = 0;
			...
			itemDef.maleWearId = 64002;
			itemDef.femaleWearId = 64002;
		break;
		case 20314: 
			itemDef.modelID = 64502;
		    itemDef.name = "Staff of Gods";
		    itemDef.modelZoom = 1385;
		    itemDef.modelRotation2 = 0;
		    itemDef.modelRotation1 = 24;
		    itemDef.maleWearId = 64503;
		    itemDef.femaleWearId = 64503;
		    itemDef.groundActions = new String[5];
		    itemDef.groundActions[2] = "Take";
		    itemDef.actions = new String[5];
		    itemDef.actions[1] = "Wield";
